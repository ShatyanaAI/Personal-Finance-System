                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-budget_id"> Budget Id</th>
                                                <th  class="td-option_id"> Option Id</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-budget_id">
                                                        <span  data-value="<?php echo $data['budget_id']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("transactions/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="budget_id" 
                                                            data-title="Enter Budget Id" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="number" 
                                                            data-mode="popover" 
                                                            data-showbuttons="left" 
                                                            class="is-editable" >
                                                            <?php echo $data['budget_id']; ?> 
                                                        </span>
                                                    </td>
                                                    <td class="td-option_id">
                                                        <span  data-value="<?php echo $data['option_id']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("transactions/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="option_id" 
                                                            data-title="Enter Option Id" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="number" 
                                                            data-mode="popover" 
